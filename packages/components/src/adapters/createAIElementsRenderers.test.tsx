...
function createMockComponents(): AIElementsComponents {
  return {
    ...
    PromptInput: ({ onSubmit, children, className, ...rest }: any) => (
      <form
    ...
    PromptInputSubmit: ({ status, onClick, ...rest }: any) => (
      <button
    ...
    PromptInputFooter: ({ children, ...rest }: any) => (
